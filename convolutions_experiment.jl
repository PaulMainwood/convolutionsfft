...
# ╔═╡ df0f25d0-871c-11ee-08d4-bb33a717cc9f
using Distributions, FFTW, StatsPlots, PlutoUI

# ╔═╡ 0d7b607f-3d81-47d1-b5f1-37b913c7e93e
#Convolution function a fft implementation from Seth Axon, shared here: https://discourse.julialang.org/t/distribution-of-sum-of-random-variables/69023/5
...
# ╔═╡ 63fde59e-0ed5-459b-af26-090015c13215
md"""
Before value
"""

# ╔═╡ fbd8dd6c-68c2-40e8-a4d3-66d1195b8068
@bind before Slider(-10:10, default=1, show_value=true)

# ╔═╡ 57ecf0ea-b141-4fd4-8213-ce78fc9419e5
md"""
After value
"""

# ╔═╡ 6614d115-f278-41d9-8f07-91ef16a8d25d
@bind after Slider(-10:10, default=-1, show_value=true)

# ╔═╡ fcbcfcec-4d66-4f32-944d-6893a05e15cb
begin
g = Uniform(-100, 0)
j = Weibull(1.63, 22.36)
h = LogNormal(2.82, 0.56)
k = Gamma(3.07, 6.67)
...
# ╔═╡ e56a4a6d-bfa5-4c77-b573-f291efdd1b82
begin
_, fpdf_lognormal = convolvedists(x, g, h)
_, fpdf_gamma = convolvedists(x, g, k)
_, fpdf_weibull = convolvedists(x, g, j);
end;

# ╔═╡ d1ebe45e-da28-4fa5-90cc-2d1afc325195
begin
fpdf_lognormal_scaled = (fpdf_lognormal .* (before - after) .* 100) .+ after
fpdf_gamma_scaled = (fpdf_gamma .* (before - after) .* 100) .+ after
fpdf_weibull_scaled = (fpdf_weibull .* (before - after) .* 100) .+ after;
end;

# ╔═╡ 184264ec-9427-4863-9a86-335e38ea71ba
begin
plot(; size=(700, 500))
#density!(f_samples; label="sample KDE", xlabel="x", ylabel="density")
plot!(x, fpdf_lognormal_scaled; label="Lognormal", xlim=(-10, 60), xlabel = "Time", ylabel = "Response")
plot!(x, fpdf_gamma_scaled; label="Gamma")
plot!(x, fpdf_weibull_scaled; label = "Weibull")
end
...
julia_version = "1.8.3"
manifest_format = "2.0"
project_hash = "0af4ac3a7e8cc8a09c0e94ecce61d7dc4b02e810"
